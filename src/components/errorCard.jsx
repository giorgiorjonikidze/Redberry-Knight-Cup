...
const ErrorCard = ({ message, onErrorClose }) => {
  ...
  return (
    <div className="w-[350px] h-[87px] border-[1px] border-solid bg-white border-opacity-10 shadow-black opacity-15 mt-[20px] rounded-[8px]">
      ...
      <p className="text-[#212529] pt-[12px] px-[12px]">
